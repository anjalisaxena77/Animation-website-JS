...
// jab mouse move ho toh humlog skew kar paaye or max skew or min skew set kar paye.
// jab mouse move ho toh chapta ki value badhe,aur jab mouse chalna band ho jaaye to chapta hata lo
function circleflat(){
    // define default scale value
    var xscale = 1;
    var yscale = 1;
//   to save previous value
    var xprev = 0; 
    var yprev = 0;
...
uske baad teeno par ek mousemove lagao,
